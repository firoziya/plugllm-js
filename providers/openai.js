...
class ChatOpenAI extends BaseLLM {
  constructor({ model = 'gpt-4o', apiKey = null, baseUrl = 'https://api.openai.com/v1', timeout = 60, maxHistory = 10, ...config } = {}) {
    super(model, apiKey, maxHistory, config);
    this.baseUrl = baseUrl;
    this.timeout = timeout;
  }

  _getEnvVarName() { return 'OPENAI_API_KEY'; }
