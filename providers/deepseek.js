...
class ChatDeepSeek extends BaseLLM {
  constructor({ model = 'deepseek-chat', apiKey = null, timeout = 60, maxHistory = 10, ...config } = {}) {
    super(model, apiKey, maxHistory, config);
    this.baseUrl = 'https://api.deepseek.com';
    this.timeout = timeout;
  }

  _getEnvVarName() { return 'DEEPSEEK_API_KEY'; }
  ...
  async generate(prompt, kwargs = {}) {
    ...
    const payload = { model: this.model, messages, stream: false, ...this.config, ...kwargs };
