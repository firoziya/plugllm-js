...
class ChatMistral extends BaseLLM {
  constructor({ model = 'mistral-large-latest', apiKey = null, timeout = 60, maxHistory = 10, ...config } = {}) {
    super(model, apiKey, maxHistory, config);
    this.baseUrl = 'https://api.mistral.ai/v1';
    this.timeout = timeout;
  }

  _getEnvVarName() { return 'MISTRAL_API_KEY'; }
